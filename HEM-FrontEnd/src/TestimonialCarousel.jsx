...
class TestimonialCarousel extends React.Component {
  render() {
    return (
      <div className="bg-hemautoTransparent w-[75%]r">
        <Carousel
          stopOnHover
          autoPlay
          interval="5000"
